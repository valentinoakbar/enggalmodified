          ...
          <div class="col-lg-12 ">
            <div class="hero__search">
              <div class="hero__search__form">
                <form action="#">
                  <input type="text" placeholder="Cari apa brads?" />
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer__about">
              ...
              <ul>
                <li>Jl. Diponegoro No.2, Dusun Krajan, Gambiran, Kec. Gambiran, Kabupaten Banyuwangi, Jawa Timur 68465</li>
                <li>Phone: 081233058566</li>
                <li>Email: enggalmodified@yahoo.com</li>
              </ul>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 col-sm-6 offset-lg-1">
            <div class="footer__widget">
              <h6>Sosial Media</h6>
              <ul>
                <li><a href="https://instagram.com/enggal_modified/">Instagram</a></li>
                <li><a href="https://youtube.com/@ENGGALMODIFIED">Youtube</a></li>
                <li><a href="https://facebook.com/profile.php?id=100065028120869">Facebook</a></li>
